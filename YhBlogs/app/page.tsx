...
export default function Home() {
  const allPosts = getAllPosts()
    ...
    .map((post) => ({
      ...
      formattedDate: formatUpdateTime(post.meta.date || '1970-01-01'),
    }));
  ...
  const allChatters = getAllChatters().map((chatter) => ({
    slug: chatter.meta.slug,
    title: chatter.meta.title || '碎片记录',
    description: chatter.content.substring(0, 60),
    cover: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=1000&auto=format&fit=crop',
    date: chatter.meta.date || '1970-01-01',
    formattedDate: formatUpdateTime(chatter.meta.date || '1970-01-01'),
  }));
